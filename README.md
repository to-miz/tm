...
tm_utility.h | Utility and convenience functions, mainly for my personal use | C++11 | v1.0.9a
tm_arrayview.h | Lightweight ArrayView and UninitializedArrayView classes for POD types, allows treating static arrays and memory regions like std containers with insertion/erase. No memory allocation/resizing. | C++11 | v1.1b
