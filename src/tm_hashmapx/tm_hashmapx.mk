...
${unmerged.tm_hashmapx.out}: ${unmerged_deps} src/tm_hashmapx/*.cpp src/tm_hashmapx/*.h
	${hide}echo Compiling $@.
...
${unmerged.tm_hashmapx.c.out}: ${unmerged_deps} src/tm_hashmapx/*.cpp src/tm_hashmapx/test.c src/tm_hashmapx/*.h
	${hide}echo Compiling $@.
